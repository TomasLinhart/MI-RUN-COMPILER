...
{
    public class MoreThanExpression : Expression
    {
        public Expression LeftExpression { get; private set; }
        public Expression RightExpression { get; private set; }

        [Rule("<CompareExpression> ::= <CompareExpression> ~'>'  <ShiftExpression>")]
        public MoreThanExpression(Expression leftExpression, Expression rightExpression)
        {
        ...
        {
            return string.Format("{0} more than {1}", LeftExpression, RightExpression);
        }
        ...
        public override List<InstructionModel> GetInstructions(CompilationModel model)
        {
            ...
            instructions.Add(new InstructionModel(Instructions.IfIntGtInstruction, "3"));
